...
- Official stdio smoke coverage using the Python MCP client SDK.
- Copy-paste-run example documentation for health, meeting-memory, and multi-agent demos.
...
- Added a 30-second MCP primer and honest pre-PyPI install guidance across public onboarding docs.
- Configured tagged releases to publish a GitHub release page with autogenerated notes and attached artifacts.
